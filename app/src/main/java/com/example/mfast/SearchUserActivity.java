...
public class SearchUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goBack = findViewById(R.id.go_back_home_from_search);
        searchUser = findViewById(R.id.search_user_button);
        enterUserName = findViewById(R.id.search_user_edit_text);
        ...
        goBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SearchUserActivity.this,HomeActivity.class));
                finish();
            }
        });
    }
    ...
    private void showAllUsers(String details){
        ...
        FirebaseRecyclerAdapter<SearchUsers,FindFriendsViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull final FindFriendsViewHolder holder, int position, @NonNull SearchUsers model) {
                ...
                holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(otherUserId.equals(currentUser)){
                            startActivity(new Intent(SearchUserActivity.this,userProfile.class));
                        }
                        else{
                            Intent intent = new Intent(SearchUserActivity.this,OtherUserCompleteProfile.class);
